                    ...
                    <div class="card-body mb-2">
                        <div class="my-2">
                            <span id="msg-span">
                                ...
                                La información disponible puede ser limitada en las fuentes públicas consultadas.
                            </span>
                        ...
                        <div class="table-responsive-md">
                            <table class="table table-bordered table-hover table-sm table-condensed" id="table-dni" style="display: none">
